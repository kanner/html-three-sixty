...
this.points=[[0,0,0],
// точки поверхности корпуса (верхняя часть)
[-17,40,7],[-16,40,8],[-17,-40,7],[-16,-40,8],[-15,-40,3],[-15,-45,3],[-10,-40,3],[-10,-42,3],
[17,40,7],[16,40,8],[17,-40,7],[16,-40,8],[15,-40,3],[15,-45,3],[10,-40,3],[10,-42,3],
// точки поверхности корпуса (нижняя часть)
[-17,40,-7],[-16,40,-8],[-17,-40,-7],[-16,-40,-8],[-15,-40,-3],[-15,-45,-3],[-10,-40,-3],[-10,-42,-3],
[17,40,-7],[16,40,-8],[17,-40,-7],[16,-40,-8],[15,-40,-3],[15,-45,-3],[10,-40,-3],[10,-42,-3],
];
...
this.points=[[0,0,0],
// точки поверхности usb с дырками (верхняя часть)
[-12,46,4],[-12,70,4],[-8,56,4],[-8,60,4],[-4,56,4],[-4,60,4],
[12,46,4],[12,70,4],[8,56,4],[8,60,4],[4,56,4],[4,60,4],
// точки поверхности usb с дырками (нижняя часть)
[-12,46,-4],[-12,70,-4],[-8,56,-4],[-8,60,-4],[-4,56,-4],[-4,60,-4],
[12,46,-4],[12,70,-4],[8,56,-4],[8,60,-4],[4,56,-4],[4,60,-4],
...
this.faces=[
// горизонтальная поверхность usb
[3,4,6,5],[11,12,10,9],
[1,2,8,7],
// нижняя поверхность usb
[15,16,18,17],[21,22,24,23],
[13,14,20,19],
// внутренняя поверхность usb
[25,26,28,27],
...
{
this.points=[[0,0,0],
// колпачок (верхняя часть)
[-17,122,4],[-16,122,5], [-17,90,4],[-16,90,5],
[17,122,4],[16,122,5], [17,90,4],[16,90,5],
// колпачок (нижняя часть)
[-17,122,-4],[-16,122,-5], [-17,90,-4],[-16,90,-5],
[17,122,-4],[16,122,-5], [17,90,-4],[16,90,-5],
// колпачок (внутренняя часть)
];

this.faces=[
// колпачок (верхняя и нижняя части)
